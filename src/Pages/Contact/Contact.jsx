...
export default function Contact() {
  return (
    <div>
      ...
      <div className="mt-10 mb-2 px-6 md:px-12">
        <h1 className="text-4xl text-center my-10 font-semibold">Connect with Us: Your Questions Answered!</h1>
        <div
          ...
          <div className="w-full shrink-0 grow-0 basis-auto lg:w-7/12">
            ...
            <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
              <form>
                ...
                <button type="button"
                  className="mb-6 w-full rounded bg-sky-500  px-6 pt-2.5 pb-2 text-xs font- uppercase leading-normal   lg:mb-0 text-white font-semibold border-none bg-gradient-to-r from-[#ec4554] to-[#f36a39]">
                  Send
                </button>
              </form>
            </div>
