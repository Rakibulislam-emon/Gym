    ...
    <div className="h-full py-20">
      <div className="mx-auto">
        ...
        <div className="flex justify-center px-6 py-12 flex-col-reverse lg:flex-row">
          <div
            className="w-full lg:w-3/12 lg:bg-cover bg-gray-400 dark:bg-gray-800 rounded-lg mb-6 lg:mb-0 order-2 lg:order-1"
            style={{
          ...
          <div className="w-full lg:w-7/12 bg-white dark:bg-gray-700 p-5 rounded-lg lg:rounded-l-lg order-1 lg:order-2">
            ...
            <form
              ...
              className="px-8 pt-6 pb-8 mb-4 bg-white dark:bg-gray-800 rounded w-full"
            >
